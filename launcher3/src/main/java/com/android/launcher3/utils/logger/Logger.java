package com.android.launcher3.utils.logger;
...
//        Log.i("llll", "0: " + getSimpleClassName(trace[0].getClassName()) + trace[0].getFileName());
//        Log.i("llll", "1: " + getSimpleClassName(trace[1].getClassName()) + trace[1].getFileName());
//        Log.i("llll", "2: " + getSimpleClassName(trace[2].getClassName()) + trace[2].getFileName());
//        Log.i("llll", "3: " + getSimpleClassName(trace[3].getClassName()) + trace[3].getFileName());
//        Log.i("llll", "4: " + getSimpleClassName(trace[4].getClassName()) + trace[4].getFileName());
//        Log.i("llll", "5: " + getSimpleClassName(trace[5].getClassName()) + trace[5].getFileName());
//        Log.i("llll", "6: " + getSimpleClassName(trace[6].getClassName()) + trace[6].getFileName());
//        Log.i("llll", "7: " + getSimpleClassName(trace[7].getClassName()) + trace[7].getFileName());
//        Log.i("llll", "8: " + getSimpleClassName(trace[8].getClassName()) + trace[8].getFileName());
//        Log.i("llll", "9: " + getSimpleClassName(trace[9].getClassName()) + trace[9].getFileName());
//        Log.i("llll", "10: " + getSimpleClassName(trace[10].getClassName()) + trace[10].getFileName());
