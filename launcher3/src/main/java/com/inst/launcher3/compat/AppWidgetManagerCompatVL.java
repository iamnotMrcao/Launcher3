...
package com.inst.launcher3.compat;
...
import com.inst.launcher3.IconCache;
...
class AppWidgetManagerCompatVL extends AppWidgetManagerCompat {
    ...
    public void startConfigActivity(AppWidgetProviderInfo info, int widgetId, Activity activity,
        ...
        try {
            ...
            Toast.makeText(activity, com.inst.launcher3.R.string.activity_not_found, Toast.LENGTH_SHORT).show();
    ...
    public Bitmap getBadgeBitmap(AppWidgetProviderInfo info, Bitmap bitmap) {
        ...
        final int badgeSize = res.getDimensionPixelSize(com.inst.launcher3.R.dimen.profile_badge_size);
        final int badgeMargin = res.getDimensionPixelSize(com.inst.launcher3.R.dimen.profile_badge_margin);
