...
import com.inst.launcher3.LauncherSettings.Favorites;
...
public class Workspace extends SmoothPagedView
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    public void updatePackageState(ArrayList<PackageInstallerCompat.PackageInstallInfo> installInfos) {
        for (final PackageInstallerCompat.PackageInstallInfo installInfo : installInfos) {
